...
<body style="overflow-x: hidden !important; position:relative !important;">
  ...
  include_once "./backend/createuser.php";
  ?>
...
>
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control cuser-input" autocomplete="off" name="name" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1" required>
            </div>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
              ...
              <input type="text" class="form-control cuser-input" autocomplete="off" name="email" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" required>
            </div>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text input-group-text-cuser" id="basic-addon1">
              ...
              <input type="digits" class="form-control cuser-input" autocomplete="off" name="balance" placeholder="Balance" aria-label="Balance" aria-describedby="basic-addon1" required>
            </div>
            <?php 
                $status = $_GET['userexists'];
                if($status == 1){
                  ?>
                  <p class="text-center text-danger font-italic">User Already Exists! Try using different account...</p>
            <?php
                }else{
            ?>
            <?php    
