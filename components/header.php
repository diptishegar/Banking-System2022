...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
  <div class="container-fluid py-3">
    <a style="font-size:28px" class="navbar-brand font-weight-bold" href="index.php">Banking System</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav d-flex">
        ...
        <li class="nav-item btn btn-outline-dark p-0 create-user-btn">
          <a class="nav-link text-white" href="create-user.php">Create User</a>
        </li>
      </ul>
    </div>
  </div>
